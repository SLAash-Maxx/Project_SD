        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityRevealed = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ML, Deep Learning, NLP", true, "Artificial Intelligence" },
                    { 2, "Frontend, Backend, APIs", true, "Web Development" },
                    { 3, "Network security, pen testing, cryptography", true, "Cybersecurity" },
                    { 4, "AWS, Azure, GCP, DevOps", true, "Cloud Computing" },
                    { 5, "iOS, Android, cross-platform", true, "Mobile Development" },
                    { 6, "Analytics, visualisation, big data", true, "Data Science" }
                });
